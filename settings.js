...
SESSION_ID: process.env.SESSION_ID === undefined ? '𝙰𝚂𝙸𝚃𝙷𝙰-𝙼𝙳=muxGVaBb#wi-UimM5u4218qewY-sXgVlI3XnMwcpZGZbCb-eax60' : process.env.SESSION_ID,
PREFIX: process.env.PREFIX || '.' ,
PORT: process.env.PORT === undefined ? "8000" : process.env.PORT,
SUDO: process.env.SUDO === undefined ? '923314110070' : process.env.SUDO,
...
NEWS_SEND_JID: process.env.NEWS_SEND_JID === undefined ? ".forward 120363270963036548@g.us.forward 120363356804655907@g.us" : process.env.NEWS_SEND_JID,
